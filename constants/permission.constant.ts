...
export const PERMISSION_GRAPHQL_SHOW_PERMISSION = 'graphql-show-permission';
export const PERMISSION_GRAPHQL_DETAIL_PERMISSION = 'graphql-detail-permission';
export const PERMISSION_GRAPHQL_UPDATE_PERMISSION = 'graphql-update-permission';
