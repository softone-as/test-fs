...
import { TCMovieScheduleFormProps } from 'apps/backoffice/@contracts/movie/movie-schedule/movie-schedule-create.contract';
import { TCMovieScheduleDetailProps } from 'apps/backoffice/@contracts/movie/movie-schedule/movie-schedule-detail.contract';
import { TCMovieScheduleIndexProps } from 'apps/backoffice/@contracts/movie/movie-schedule/movie-schedule-index.contract';
