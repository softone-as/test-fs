...
import { TCTagFormProps } from 'apps/backoffice/@contracts/movie/tag/tag-create.contract';
import { TCTagDetailProps } from 'apps/backoffice/@contracts/movie/tag/tag-detail.contract';
import { TCTagIndexProps } from 'apps/backoffice/@contracts/movie/tag/tag-index.contract';
