...
import { TCStudioFormProps } from 'apps/backoffice/@contracts/movie/studio/studio-create.contract';
import { TCStudioDetailProps } from 'apps/backoffice/@contracts/movie/studio/studio-detail.contract';
import { TCStudioIndexProps } from 'apps/backoffice/@contracts/movie/studio/studio-index.contract';
