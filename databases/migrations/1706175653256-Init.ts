...
export class Init1706175653256 implements MigrationInterface {
    name = 'Init1706175653256';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE \`role_permissions\` (\`roles_id\` int NOT NULL, \`permission_id\` int NOT NULL, INDEX \`IDX_ad074b0f95ff0488162868be2c\` (\`roles_id\`), INDEX \`IDX_17022daf3f885f7d35423e9971\` (\`permission_id\`), PRIMARY KEY (\`roles_id\`, \`permission_id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
