...
export class Init1706664176108 implements MigrationInterface {
    name = 'Init1706664176108';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE \`users\` (\`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`id\` int NOT NULL AUTO_INCREMENT, \`fullname\` varchar(255) NOT NULL, \`email\` varchar(255) NULL, \`password\` varchar(255) NOT NULL, \`identity_number\` varchar(255) NOT NULL, \`phone_number\` varchar(255) NOT NULL, \`one_signal_player_ids\` json NULL, \`email_verified_at\` datetime NULL, \`phone_number_verified_at\` datetime NULL, \`gender\` varchar(255) NOT NULL, \`birth_date\` datetime NULL, UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), UNIQUE INDEX \`IDX_43d2ef62e309fe8f4bae2a67e5\` (\`identity_number\`), UNIQUE INDEX \`IDX_17d1817f241f10a3dbafb169fd\` (\`phone_number\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE \`user_roles\` (\`roles_id\` int NOT NULL, \`users_id\` int NOT NULL, INDEX \`IDX_4a08d003e00caf075a4a212d23\` (\`roles_id\`), INDEX \`IDX_8e1215206acb19f1c38dbda909\` (\`users_id\`), PRIMARY KEY (\`roles_id\`, \`users_id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
