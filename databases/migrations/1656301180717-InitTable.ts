...
export class InitTable1656301180717 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE \`user_addresses\` DROP FOREIGN KEY \`FK_0a917f31ee760bfe793ebda49b4\``,
        );
        await queryRunner.query(
            `ALTER TABLE \`user_addresses\` DROP FOREIGN KEY \`FK_7a5100ce0548ef27a6f1533a5ce\``,
        );
        await queryRunner.query(
            `ALTER TABLE \`districts\` DROP FOREIGN KEY \`FK_d7d1704cfb8bc19fb0d9c2f7ced\``,
        );
        await queryRunner.query(
            `ALTER TABLE \`cities\` DROP FOREIGN KEY \`FK_42a294591feef6af3d96d60132a\``,
        );
        await queryRunner.query(
            `ALTER TABLE \`regions\` DROP FOREIGN KEY \`FK_88710f9af21f62e1bf43bbce751\``,
        );
        await queryRunner.query(
